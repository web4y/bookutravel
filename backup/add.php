                        ...
                        <div class="navbar-collapse">
                            ...
                            <ul class="nav navbar-nav hidden-xs">
                                ...
                                <li>
                                    ...
                                    <a href="#" target="_blank" id="WhatsApp">
                                        ...
                                        <span style="display:inline-block; margin-right:0px;">
                                            ...
                                            <img src="content/images/whatsapp.png?v=1" alt="WhatsApp chat">

                                        </span>Chat Us<span>|</span>
                                ...
                                <li id="li_fb_login">
                                    ...
                                    <a onclick="checkLoginState();" style="margin-top:-3px; cursor:pointer;"><img src="content/images/db-small-but.jpg?v=1" alt="fb login"><span>|</span></a>



                                </li>

                                <li style="display:none" id="li_fb_logout">

                                    <a onclick="logoutFacebook();" href="#" style="margin-top:-3px; cursor:pointer;"><img src="#" alt="fb logout"><span>|</span></a>
	 ...
	 <nav class="navbar navbar-inverse" role="navigation">
                ...
                <div class="container">
                    ...
                    <div class="navbar-brand">
                        ...
                        <a href="index.htm">
                            ...
                            <img src="content/images/bookutravel-logo.png" alt="BookUTravel.com" title="BookUTravel.com">                           
                    ...
                    <div class="top-nav-container">
                        ...
                        <div id="navbar" class="navbar-collapse collapse main-nav">
                              ...
                              <ul class="nav navbar-nav">
                                ...
                                <li style="position:relative; color:#FF0">

                                    <a href="cruise.html" id="li-supports">Cruise</a><span class="module-new">New</span>
		...
		<div class="carousel-inner">
                ...
                <div class="item active">                    
                    ...
                    <img src="content/images/full.jpg" alt="BookUTravel" style="width:100%; height:100%;">
                    ...
                    <div class="container">                        
                        ...
                        <div class="banner-ad-con home-bnr-ad">

<?php

// Connects to your Database

mysql_connect("localhost", "artrcfaw_bookutravel", "artravel80!") or die(mysql_error());

mysql_select_db("artrcfaw_reg") or die(mysql_error());
	...
	<footer id="footer">
		...
		<div class="mob-footer">
			...
			<ul>
				...
				<li><a href="#" id="Footer-whtsp-Mobile-clk"><span style="display:inline-block;margin-right:3px;"><img src="content/images/whatsapp.png?v=1" alt="Whatsapp"></span><span style="display:inline-block;margin-top:2px;">WhatsApp</span></a></li>

				<li><a href="mailto:info@bookotrip.com" id="Footer-email-Mobile-clk"><i class="fa fa-envelope" aria-hidden="true"></i> Write Us</a></li>

				<li><a href="tel:+18884377922" id="Footer-tollfree-Mobile-clk"><i class="fa fa-phone" aria-hidden="true"></i> Call Us</a></li>            
			...
			<div class="mob-footer-link clearfix">
				...
				<div class="col-xs-6">
					...
					<a href="#">Copyright Informations</a>
			...
			<div class="container">
				...
				<div class="need-help">
					...
					<ul itemscope="" itemtype="http://schema.org/Organization">
						...
						<li class="callus"><span class="need-hd">Call Us</span><a href="tel:+359877888774" id="Footer-tollfree-clk"><i class="fa fa-phone" aria-hidden="true"></i> 0877888774</a>

							<span style="display:inline-block; color:#fff; margin-left:5px;"><span style="display:inline-block; color:#fff; margin-right:2px;"><img src="https://www.bookutravel.com/content/images/whatsapp.png?v=1" alt="Whatsapp"></span>0877888774</span>
						...
						<li class="social">
							...
							<span class="need-hd">Connect with us</span>

							<span><a href="#" rel="me" target="_blank"><i class="fa fa-facebook" aria-hidden="true" id="Social-fb-clk"></i></a></span>                        

							<span><a href="#" rel="me" target="_blank"><i class="fa fa-twitter" aria-hidden="true" id="Social-twt-clk"></i></a></span>

							<span><a href="#" rel="me" target="_blank"><i class="fa fa-linkedin" aria-hidden="true" id="Social-lnkdn-clk"></i></a></span>

							<span><a href="#" rel="me" target="_blank"><i class="fa fa-pinterest-p" aria-hidden="true" id="Social-pin-clk"></i></a></span>

							<span><a href="#" rel="me" target="_blank"><i class="fa fa-instagram" aria-hidden="true" id="Social-insta-clk"></i></a></span>

							<span><a href="#" rel="me" target="_blank"><i class="fa fa-youtube" aria-hidden="true" id="Social-ytbe-clk"></i></a></span>
